package com.example.dhbootcamp.meli.obterdiploma.util;
...
public class TestUtilsGenerator {
    ...
    public static void emptyUsersFile() {
        ...
        try {
            writer = new PrintWriter(ResourceUtils.getFile("./src/resources/" + SCOPE + "/users.json"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static StudentDTO getNewStudentWithOneSubject() {
        ...
        SubjectDTO subject1 = new SubjectDTO("Espanhol", 10.0);
    ...
    public static StudentDTO getStudentWith3Subjects(String name) {
        SubjectDTO subject1 = new SubjectDTO("Inglês", 7.5);
        SubjectDTO subject2 = new SubjectDTO("Língua Portuguesa", 8.8);
        SubjectDTO subject3 = new SubjectDTO("Física", 9.9);
    ...
    public static void appendNewStudent(StudentDTO stu) {
        ...
        try {
            String content = Files.readString(new File("./src/resources/" + SCOPE + "/users.json").getAbsoluteFile().toPath(), StandardCharsets.US_ASCII);
            writer = new PrintWriter(ResourceUtils.getFile("./src/resources/" + SCOPE + "/users.json"));
